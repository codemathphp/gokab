...
// Simple hook to read session from localStorage without triggering updates
...
// Auth Store - Minimal state, mostly for compatibility
export const useAuthStore = create((set) => ({
  ...
  setUser: (user) => {
    if (typeof window !== 'undefined') {
      ...
      set({ user, sessionPersisted: !!user })
    }
  },
